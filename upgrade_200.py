...
def initialize():
    upgrade.registry.registerUpgrader(
        IndexerUpgrader(), '2.0', 'Silva Indexer')
    upgrade.registry.registerUpgrader(
        AutoTOCUpgrader(), '2.0', 'Silva AutoTOC')
    upgrade.registry.registerUpgrader(
        IndexItemUpgrader(), '2.0', upgrade.AnyMetaType)
    upgrade.registry.registerUpgrader(
        CatalogRefresher(), '2.0', upgrade.AnyMetaType)
    upgrade.registry.registerUpgrader(
        InvisibleMan(), '2.0', upgrade.AnyMetaType)
    upgrade.registry.registerUpgrader(
        LanguageMetadataLowerCaser(), '2.0', upgrade.AnyMetaType)
