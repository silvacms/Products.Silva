...
return view.request_processed(message="You are now a registered user. Your username is '%s'. Write down your username and password so you won't forget them!" % request['username'])
