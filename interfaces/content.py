...
class IFolder(IContainer):
    ...
    def set_silva_addables_allowed_in_container(addables):
        """Set the list of addables explicitly allowed in this container.
        If 'addables' is set to None the list is acquired from the
        container higher in the hierarchy. If this is the root,
    ...
    def is_silva_addables_acquired():
        ...
        above (set_silva_addables_allowed_in_container set to None), false
        if not.
        """
