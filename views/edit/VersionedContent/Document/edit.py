...
request.set('xml_rel_url', '/%s/%s/content' % (model.absolute_url(1), model.get_unapproved_version()))

service_editor = context.service_editor
service_editor.setDocumentEditor(editable.content.documentElement, 'service_doc_editor')
