...
class SetTestCase(SilvaTestCase.SilvaTestCase):
    def test_xml_folder_export(self):
        ...
        self.assertEquals('</silva-extra:modificationtime><silva-extra:publicationtime/><silva-extra:renderer_name/><silva-extra:subject/></set></metadata><content><default><auto_toc id="index"><metadata><set id="silva-content"><silva-content:maintitle>This is &lt;boo&gt;a&lt;/boo&gt; testfolder</silva-content:maintitle><silva-content:shorttitle/></set><set id="silva-extra"><silva-extra:comment/><silva-extra:contactemail/><silva-extra:contactname/><silva-extra:content_description/><silva-extra:creationtime type="datetime">', part4)
        ...
        self.assertEquals('</silva-extra:modificationtime><silva-extra:publicationtime/><silva-extra:renderer_name/><silva-extra:subject/></set></metadata><content><default><auto_toc id="index"><metadata><set id="silva-content"><silva-content:maintitle>This is &amp;another; testfolder</silva-content:maintitle><silva-content:shorttitle/></set><set id="silva-extra"><silva-extra:comment/><silva-extra:contactemail/><silva-extra:contactname/><silva-extra:content_description/><silva-extra:creationtime type="datetime">', part8)
        ...
        self.assertEquals('</silva-extra:modificationtime><silva-extra:publicationtime/><silva-extra:renderer_name/><silva-extra:subject/></set></metadata></auto_toc></default></content></folder></content></folder></silva>', part10)
    ...
    def test_xml_ghost_export(self):
        ...
        self.assertEquals('</silva-extra:modificationtime><silva-extra:publicationtime/><silva-extra:renderer_name/><silva-extra:subject/></set></metadata><content><default><auto_toc id="index"><metadata><set id="silva-content"><silva-content:maintitle>This is yet &amp;another; testfolder</silva-content:maintitle><silva-content:shorttitle/></set><set id="silva-extra"><silva-extra:comment/><silva-extra:contactemail/><silva-extra:contactname/><silva-extra:content_description/><silva-extra:creationtime type="datetime">', part4)
    ...
    def test_xml_ghost_folder_export(self):
        ...
        self.assertEquals('</silva-extra:modificationtime><silva-extra:publicationtime/><silva-extra:renderer_name/><silva-extra:subject/></set></metadata><content><default><auto_toc id="index"><metadata><set id="silva-content"><silva-content:maintitle>This is yet &amp;another; testfolder</silva-content:maintitle><silva-content:shorttitle/></set><set id="silva-extra"><silva-extra:comment/><silva-extra:contactemail/><silva-extra:contactname/><silva-extra:content_description/><silva-extra:creationtime type="datetime">', part4)
        self.assertEquals('</silva-extra:creationtime><silva-extra:creator>test_user_1_</silva-extra:creator><silva-extra:expirationtime/><silva-extra:keywords/><silva-extra:lastauthor>test_user_1_</silva-extra:lastauthor><silva-extra:location>http://nohost/root/testfolder3/index</silva-extra:location><silva-extra:modificationtime type="datetime">', part5)
        self.assertEquals('</silva-extra:modificationtime><silva-extra:publicationtime/><silva-extra:renderer_name/><silva-extra:subject/></set></metadata></auto_toc></default><ghost_folder id="caspar"><content><metatype>Silva Folder</metatype><haunted_url>/root/testfolder/testfolder2</haunted_url><content><default><auto_toc id="index"><metadata><set id="silva-content"><silva-content:maintitle>This is &amp;another; testfolder</silva-content:maintitle><silva-content:shorttitle/></set><set id="silva-extra"><silva-extra:comment/><silva-extra:contactemail/><silva-extra:contactname/><silva-extra:content_description/><silva-extra:creationtime type="datetime">', part6)
        ...
        self.assertEquals(part10, '</silva-extra:modificationtime><silva-extra:publicationtime/><silva-extra:renderer_name/><silva-extra:subject/></set></metadata><url>http://www.snpp.com/</url></content></link></content></content></ghost_folder><ghost_folder id="sadcaspar"><content><metatype/><haunted_url>/root/testfolder/broken</haunted_url></content></folder></silva>')
    ...
    def test_xml_link_export(self):
        ...
        self.assertEquals('</silva-extra:modificationtime><silva-extra:publicationtime/><silva-extra:renderer_name/><silva-extra:subject/></set></metadata><url>http://www.snpp.com/</url></content></link></content></folder></content></folder></silva>', part12)
