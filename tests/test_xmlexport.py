...
class SetTestCase(SilvaTestCase.SilvaTestCase):
    ...
    def test_xml_document_export(self):
        ...
        self.assertEquals(part1, '<silva xmlns="http://infrae.com/ns/silva/0.5" xmlns:silva="http://infrae.com/namespaces/metadata/silva" xmlns:silva-extra="http://infrae.com/namespaces/metadata/silva-extra" path="/root/testfolder" url="http://nohost/root/testfolder" datetime="')
        self.assertEquals(part2, """"><folder id="testfolder"><content><document id="test_document"><workflow><version id="0"><status>unapproved</status><publication_datetime></publication_datetime><expiration_datetime></expiration_datetime></version></workflow><content version_id="0"><title></title><doc>
            <node foo="bar">承諾広告＊既に、２億、３億、５億９千万円収入者が続出<node2>boo</node2>
    ...
    def test_xml_ghost_export(self):
        ...
        self.assertEquals(part1, '<silva xmlns="http://infrae.com/ns/silva/0.5" xmlns:silva="http://infrae.com/namespaces/metadata/silva" xmlns:silva-extra="http://infrae.com/namespaces/metadata/silva-extra" path="/root/testfolder3" url="http://nohost/root/testfolder3" datetime="')
        self.assertEquals(part2, '"><folder id="testfolder3"><content><ghost id="caspar"><workflow><version id="0"><status>unapproved</status><publication_datetime></publication_datetime><expiration_datetime></expiration_datetime></version></workflow><content version_id="0"><link id="test_link"><workflow><version id="0"><status>unapproved</status><publication_datetime></publication_datetime><expiration_datetime></expiration_datetime></version></workflow><content version_id="0"><metadata><set id="silva"><silva:maintitle>This is a test link, you insensitive clod!</silva:maintitle><silva:shorttitle></silva:shorttitle></set><set id="silva-extra"><silva-extra:subject></silva-extra:subject><silva-extra:expirationtime></silva-extra:expirationtime><silva-extra:keywords></silva-extra:keywords><silva-extra:publicationtime></silva-extra:publicationtime><silva-extra:location>http://nohost/root/testfolder/testfolder2/test_link</silva-extra:location><silva-extra:contactemail></silva-extra:contactemail><silva-extra:modificationtime>')
    ...
    def test_xml_ghost_folder_export(self):
        ...
        part1, part2, part3, part4 = splittor.split(xmlexport.getXMLSource(testfolder3).xmlToString(None))
        self.assertEquals(part1, '<silva xmlns="http://infrae.com/ns/silva/0.5" xmlns:silva="http://infrae.com/namespaces/metadata/silva" xmlns:silva-extra="http://infrae.com/namespaces/metadata/silva-extra" path="/root/testfolder3" url="http://nohost/root/testfolder3" datetime="')
        self.assertEquals(part2, '"><folder id="testfolder3"><content><ghost_folder id="caspar"><content><folder id="testfolder2"><content><link id="test_link"><workflow><version id="0"><status>unapproved</status><publication_datetime></publication_datetime><expiration_datetime></expiration_datetime></version></workflow><content version_id="0"><metadata><set id="silva"><silva:maintitle>This is a test link, you insensitive clod!</silva:maintitle><silva:shorttitle></silva:shorttitle></set><set id="silva-extra"><silva-extra:subject></silva-extra:subject><silva-extra:expirationtime></silva-extra:expirationtime><silva-extra:keywords></silva-extra:keywords><silva-extra:publicationtime></silva-extra:publicationtime><silva-extra:location>http://nohost/root/testfolder/testfolder2/test_link</silva-extra:location><silva-extra:contactemail></silva-extra:contactemail><silva-extra:modificationtime>')
        self.assertEquals(part3, '</silva-extra:modificationtime><silva-extra:creationtime>')
