...
class SetTestCase(SilvaTestCase.SilvaTestCase):
    ...
    def test_xml_document_export(self):
        ...
        self.assertEquals(part2, """"><folder id="testfolder"><content><document id="test_document"><workflow><version id="0"><status>unapproved</status><publication_date></publication_date><expiration_date></expiration_date></version></workflow><content version_id="0"><title></title><doc>
            <node foo="bar">承諾広告＊既に、２億、３億、５億９千万円収入者が続出<node2>boo</node2>
    ...
    def test_xml_folder_export(self):
        ...
        part1, part2 = splittor.split(xmlexport.getXMLSource(testfolder).xmlToString(None))
        self.assertEquals(part1, '<silva xmlns="http://infrae.com/ns/silva/0.5" path="/root/testfolder" url="http://nohost/root/testfolder" datetime="')
        self.assertEquals(part2, '"><folder id="testfolder"><content><folder id="testfolder2"><content></content></folder></content></folder></silva>')
    ...
    def test_xml_ghost_export(self):
        ...
        self.assertEquals(part2, '"><folder id="testfolder3"><content><ghost id="caspar"><workflow><version id="0"><status>unapproved</status><publication_date></publication_date><expiration_date></expiration_date></version></workflow><content version_id="0"><link id="test_link"><workflow><version id="0"><status>unapproved</status><publication_date></publication_date><expiration_date></expiration_date></version></workflow><content version_id="0"><metadata><title></title><set xmlns="http://infrae.com/namespaces/metadata/silva"><maintitle>This is a test link, you insensitive clod!</maintitle><shorttitle></shorttitle></set><set xmlns="http://infrae.com/namespaces/metadata/silva-extra"><subject></subject><expirationtime></expirationtime><keywords></keywords><publicationtime></publicationtime><location>http://nohost/root/testfolder/testfolder2/test_link</location><contactemail></contactemail><modificationtime>')
        self.assertEquals(part3, '</modificationtime><creationtime>')
        self.assertEquals(part4, '</creationtime><lastauthor>unknown user</lastauthor><creator>test_user_1_</creator><contactname></contactname><content_description></content_description><comment></comment></set></metadata><url>http://www.snpp.com/</url></content></link></content></ghost></content></folder></silva>')
    ...
    def test_xml_ghost_folder_export(self):
        ...
        part1, part2, part3, part4 = splittor.split(xmlexport.getXMLSource(testfolder3).xmlToString(None))
        self.assertEquals(part1, '<silva xmlns="http://infrae.com/ns/silva/0.5" path="/root/testfolder3" url="http://nohost/root/testfolder3" datetime="')
        self.assertEquals(part2, '"><folder id="testfolder3"><content><ghost_folder id="caspar"><content><folder id="testfolder2"><content><link id="test_link"><workflow><version id="0"><status>unapproved</status><publication_date></publication_date><expiration_date></expiration_date></version></workflow><content version_id="0"><metadata><title></title><set xmlns="http://infrae.com/namespaces/metadata/silva"><maintitle>This is a test link, you insensitive clod!</maintitle><shorttitle></shorttitle></set><set xmlns="http://infrae.com/namespaces/metadata/silva-extra"><subject></subject><expirationtime></expirationtime><keywords></keywords><publicationtime></publicationtime><location>http://nohost/root/testfolder/testfolder2/test_link</location><contactemail></contactemail><modificationtime>')
        self.assertEquals(part3, '</modificationtime><creationtime>')
        self.assertEquals(part4, '</creationtime><lastauthor>unknown user</lastauthor><creator>test_user_1_</creator><contactname></contactname><content_description></content_description><comment></comment></set></metadata><url>http://www.snpp.com/</url></content></link></content></folder></content></ghost_folder></content></folder></silva>')
    ...
    def test_xml_link_export(self):
        ...
        self.assertEquals(part1, '<silva xmlns="http://infrae.com/ns/silva/0.5" path="/root/testfolder" url="http://nohost/root/testfolder" datetime="')
        self.assertEquals(part2, '"><folder id="testfolder"><content><folder id="testfolder2"><content><link id="test_link"><workflow><version id="0"><status>unapproved</status><publication_date></publication_date><expiration_date></expiration_date></version></workflow><content version_id="0"><metadata><title></title><set xmlns="http://infrae.com/namespaces/metadata/silva"><maintitle>This is a test link, you insensitive clod!</maintitle><shorttitle></shorttitle></set><set xmlns="http://infrae.com/namespaces/metadata/silva-extra"><subject></subject><expirationtime></expirationtime><keywords></keywords><publicationtime></publicationtime><location>http://nohost/root/testfolder/testfolder2/test_link</location><contactemail></contactemail><modificationtime>')
        self.assertEquals(part3, '</modificationtime><creationtime>')
        self.assertEquals(part4, '</creationtime><lastauthor>unknown user</lastauthor><creator>test_user_1_</creator><contactname></contactname><content_description></content_description><comment></comment></set></metadata><url>http://www.snpp.com/</url></content></link></content></folder></content></folder></silva>')
