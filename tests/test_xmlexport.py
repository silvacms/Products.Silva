...
class SetTestCase(SilvaTestCase.SilvaTestCase):
    ...
    def test_xml_ghost_export(self):
        ...
        self.assertEquals(part1, '<silva xmlns="http://infrae.com/ns/silva/0.5" xmlns:doc="http://infrae.com/ns/silva_document/1.0" xmlns:silva-content="http://infrae.com/namespaces/metadata/silva" xmlns:silva-extra="http://infrae.com/namespaces/metadata/silva-extra" path="/root/testfolder3" url="http://nohost/root/testfolder3" datetime="')
