...
class CopyTestCase(SilvaTestCase.SilvaTestCase):
    ...
    def test_delete8(self):
        # delete folder without default doc
        self.root.folder6.index.set_unapproved_version_publication_datetime(DateTime())
        self.root.folder6.index.approve_version()
        self.root.action_delete(['folder6'])
        self.assert_(hasattr(self.root, 'folder6'))
        self.root.folder6.index.close_version()
        self.root.action_delete(['folder6'])
        self.assert_(not hasattr(self.root, 'folder6'))
