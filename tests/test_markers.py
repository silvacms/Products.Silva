...
from silva.core.layout.interfaces import IMarkManager, ICustomizableMarker, ICustomizable
...
class CustomizationMarkerTest(SilvaTestCase.SilvaTestCase):
    ...
    def test_marker_on_root(self):
        ...
        self.assertEqual(manager.usedInterfaces,
                         ['Products.Silva.interfaces.content.IFolder', 
                          'Products.Silva.interfaces.content.IPublication', 
                          'Products.Silva.interfaces.content.IRoot'])
        ...
        self.root.manage_addProduct['silva.core.layout'].manage_addCustomizationMarker('ITestMarker')
    ...
    def test_customization_view(self):
        ...
        self.assertRaises(Unauthorized, self.root.restrictedTraverse, 'manage_customization')
        ...
        for implemented in ['Products.Silva.interfaces.content.IFolder', 
                            'Products.Silva.interfaces.content.IPublication', 
                            'Products.Silva.interfaces.content.IRoot']:
        ...
        self.failUnless('Products.Silva.interfaces.content.IFolder' in view)
